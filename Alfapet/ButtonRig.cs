    ...
    class ButtonRig : Game
    {
        ...
        public static void Initialize()
        {
            ...
            Buttons[0].DrawFunc = delegate ()
            {
                ...
                UI.DrawCenterChar(Fonts.Montserrat_Bold_Smaller, "Do Move", Buttons[0].GetPos(), Color.White, (int)Buttons[0].W, (int)Buttons[0].H);
            };
            ...
            Buttons[1].DrawFunc = delegate ()
            {
                ...
                UI.DrawCenterChar(Fonts.Montserrat_Bold_Smaller, "Something else", Buttons[1].GetPos(), Color.White, (int)Buttons[1].W, (int)Buttons[1].H);
            };
        }
    }
}
